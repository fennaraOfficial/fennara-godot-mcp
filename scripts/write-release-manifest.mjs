...
const DEFAULT_MINIMUM_CLI_VERSION = "0.3.0";
...
Usage:
  node scripts/write-release-manifest.mjs --assets-dir release-assets --out release-assets/fennara-release-manifest-v0.3.0.json
