...
pub(crate) const PROVIDER_ID: &str = ProviderId::ZAI;
pub(crate) const API_BASE: &str = "https://api.z.ai/api/paas/v4";
pub(crate) const API_KEY_ENV: &str = "ZHIPU_API_KEY";
...
pub(crate) fn model_definition(model_id: &str, display_name: Option<String>) -> ModelDefinition {
    ...
    ModelDefinition {
        id: ModelId::new(model_id).expect("Z.AI model id is valid"),
