...
pub(crate) const PROVIDER_ID: &str = ProviderId::OLLAMA_CLOUD;
pub(crate) const API_BASE: &str = "https://ollama.com/v1";
...
pub(crate) fn model_definition(model_id: &str, display_name: Option<String>) -> ModelDefinition {
    ...
    ModelDefinition {
        id: ModelId::new(model_id).expect("Ollama Cloud model id is valid"),
